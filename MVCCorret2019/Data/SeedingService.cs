...
using MVCCorret2019.Models.Enums;

namespace MVCCorret2019.Data
{
    public class SeedingService
    {
        private MVCCorret2019Context _context;

        //Injecao de dependecias da Pasta Data MVCCorret2019Context
        public SeedingService(MVCCorret2019Context context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s3 = new Seller(3, "Alex grey", "alexgrey@gmail.com", new DateTime(1998, 1, 15), 2200.0, d3);
            Seller s4 = new Seller(4, "Martha red", "marthared@gmail.com", new DateTime(1993, 11, 30), 3000.0, d4);
            Seller s5 = new Seller(5, "Doald Blue", "donaldblue@gmail.com", new DateTime(2000, 1, 9), 4000.0, d3);
